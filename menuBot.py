...
# -----------------------------------------------------------------------
m_main = Menu("Главное меню", buttons=["Пошутить", "Играть", "Анкета", "Помощь"])
m_games = Menu("Играть", buttons=["Игра КНБ-MP", "Выход"], module="botGames", parent=m_main)
m_DZ = Menu("Анкета", buttons=["дз-1", "дз-2", "дз-3", "дз-4", "дз-5", "дз-6", "дз-7",
                            "дз-8", "дз-9", "Выход"], parent=m_main, module="DZ")
m_fun = Menu("Пошутить", buttons=["Рассказать анекдот!",  "Выход"], parent=m_main, module="fun")
